...
export function LoginPage() {
  ...
  // Magia: Si la URL dice "/registro", isLogin será false automáticamente
  ...
  // Si el usuario cambia entre /login y /registro en el Navbar, la página reacciona
  useEffect(() => {
    setIsLogin(location.pathname !== '/registro');
  }, [location.pathname]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isLogin) {
      ...
      if (success) {
        ...
        alert('❌ Error al crear la cuenta. Verifica que el correo no exista ya.');
      }
    }
  };
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            {/* ... Tus botones de Google y Facebook (quedan igualitos) ... */}
          ...
          {/* Toggle Login/Register ahora usa Links reales */}
